                            ...
                            {corals.map((c) => (
                              <tr key={c.id} data-testid={`row-coral-${c.id}`} className="hover:bg-white/5">
                                <td className="px-5 py-4">
                                  <div className="flex items-center gap-3">
                                    <img src={assetUrl(c.image)} alt={c.name} className="h-10 w-10 rounded-lg object-cover" onError={(e) => { (e.currentTarget as HTMLImageElement).src = assetUrl("/figmaAssets/adopt/coral-1.png"); }} />
                                    <div>
                              ...
                              <tr key={a.id} data-testid={`row-adoption-${a.id}`} className="hover:bg-white/5">
                                ...
                                <td className="px-5 py-4">
                                  <div className="flex items-center gap-2">
                                    <img src={assetUrl(a.coralImage)} alt={a.coralName} className="h-8 w-8 rounded object-cover" onError={(e) => { (e.currentTarget as HTMLImageElement).src = assetUrl("/figmaAssets/adopt/coral-1.png"); }} />
                                    {a.coralName}
                                  </div>
                                </td>
